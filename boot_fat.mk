...
boot_fatimage: bootimage all_dtbs
	...
	cp device/linaro/hikey/grub.cfg  $(PRODUCT_OUT)/grub/
	...
	mcopy -i $(PRODUCT_OUT)/boot_fat.uefi.img $(PRODUCT_OUT)/fastboot.efi ::fastboot.efi
	mcopy -i $(PRODUCT_OUT)/boot_fat.uefi.img $(PRODUCT_OUT)/grubaa64.efi ::grubaa64.efi
	mcopy -i $(PRODUCT_OUT)/boot_fat.uefi.img $(PRODUCT_OUT)/ramdisk.img ::ramdisk.img
	mcopy -s -i $(PRODUCT_OUT)/boot_fat.uefi.img $(PRODUCT_OUT)/grub/ ::
